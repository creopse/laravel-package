...
import { i as j, a as T, c as C } from "./ckeditor_ckeditor5-integrations-common-CHweLFsE.js";
import { d as D } from "./lodash-es-DCTpQg3n.js";
let Z, E;
let __tla = (async ()=>{
    const h = {}, g = {
        vue: {
            get: ()=>()=>c(new URL("__federation_shared_vue-COVVczY1.js", import.meta.url).href),
            import: !0
        },
        pinia: {
            get: ()=>()=>c(new URL("__federation_shared_pinia-COiGO7sq.js", import.meta.url).href),
            import: !0
        },
        react: {
            get: ()=>()=>c(new URL("__federation_shared_react-CLyhJgQo.js", import.meta.url).href),
            import: !0
        },
        "react-dom": {
            get: ()=>()=>c(new URL("__federation_shared_react-dom-Cx1tLVmX.js", import.meta.url).href),
            import: !0
        },
        zustand: {
            get: ()=>()=>c(new URL("__federation_shared_zustand-BnS_JjBE.js", import.meta.url).href),
            import: !0
        }
    ...
    const w = await E("vue"), { version: K, defineComponent: N, mergeModels: y, useModel: L, ref: p, watch: b, onMounted: B, markRaw: M, onBeforeUnmount: P, createBlock: q, openBlock: S, resolveDynamicComponent: W, computed: H, watchEffect: J, shallowReadonly: Q, toValue: X } = await E("vue"), x = C("vue", {
        version: "7.3.1",
        frameworkVersion: K
    });
    function A(e) {
    ...
    Z = N({
        ...
        setup (e, { expose: i, emit: n }) {
            ...
            return R(), B(()=>{
                const t = A(Object.assign({}, s.config));
