...
let __tla = (async ()=>{
    const h = {}, g = {
        vue: {
            get: ()=>()=>c(new URL("__federation_shared_vue-Cqg6_CeL.js", import.meta.url).href),
            import: !0
        },
        pinia: {
            get: ()=>()=>c(new URL("__federation_shared_pinia-DnEebGM1.js", import.meta.url).href),
            import: !0
        },
        react: {
        ...
        zustand: {
            get: ()=>()=>c(new URL("__federation_shared_zustand-B7v6XYM3.js", import.meta.url).href),
            import: !0
        }
