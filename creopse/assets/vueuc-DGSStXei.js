import { i as F, __tla as __tla_0 } from "./ckeditor_ckeditor5-vue-CmLqe3wy.js";
import { a as J, o as fe } from "./evtd-CI_DDEu_.js";
import { i as Ae, d as pe, p as P, e as Ye, a as De } from "./seemly-C6YuW2_Q.js";
import { u as ee, __tla as __tla_1 } from "./css-render_vue3-ssr-BUkg8rSe.js";
import { d as je, u as _, o as Ne, i as _e, __tla as __tla_2 } from "./vooks-B99INock.js";
import { z as Ue } from "./vdirs-DRH9Xvnd.js";
import { R as Pe } from "./juggle_resize-observer-DB6f1vmu.js";
import { C as qe } from "./css-render-DwGtWWWe.js";
...
let __tla = Promise.all([
    ...
    function we(n) {
        return typeof n == "string" ? document.querySelector(n) : n() || null;
    }
    ...
    bn = yt({
        ...
        setup (n) {
            const e = xt("VBinder"), t = _(()=>n.enabled !== void 0 ? n.enabled : n.show), o = $e(null), r = $e(null), u = ()=>{
    ...
    let Vt, Ht, ze, Xt, q, Yt, K, Dt, X, jt, Nt, ae, _t, Ut, Pt, qt, Kt, Gt, Jt, Ie, Qt, Ee, Zt, B, Rt;
    ...
    wn = Yt({
        ...
        setup (n) {
            ...
            }), d = K(0), f = K(0), m = _(()=>Math.max(x.value.getBound(f.value - pe(n.paddingTop)) - 1, 0)), v = q(()=>{
                const { value: s } = h;
                if (s === void 0) return [];
            ...
            function Y(s, c) {
                ...
                if (H != null) {
                    if (i === void 0) {
                        const oe = I.sum(S);
                        H.scrollTop > oe && H.scrollBy(0, U);
                    } else if (S < i) H.scrollBy(0, U);
                    else if (S === i) {
                        const oe = I.sum(S);
                        W + oe > H.scrollTop + H.offsetHeight && H.scrollBy(0, U);
                    }
                    j();
                }
                d.value++;
    ...
    ({ defineComponent: Ut, h: Pt, ref: qt } = await F("vue"));
    Kt = A(".v-x-scroll", {
        overflow: "auto",
        scrollbarWidth: "none"
    }, [
