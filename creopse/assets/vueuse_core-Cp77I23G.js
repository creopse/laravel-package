import { n as T, i as Y, t as P, a as $, b as I, c as j, d as G, e as K, f as U, g as V, __tla as __tla_0 } from "./vueuse_shared-DPQY9T5X.js";
import { __tla as __tla_1 } from "./vue-demi-colorpicker-xuUwNfyJ.js";
import { r as S, d as X } from "./vue_reactivity-C5WRdemS.js";
import { w as L, c as R, aJ as Z, n as ee, aa as te, O as ne } from "./vue_runtime-core-B1rNBygi.js";
let ye, be, ge, re, ve, we;
let __tla = Promise.all([
    ...
    function _(...e) {
        ...
        }, s = (h, o, r, l)=>(h.addEventListener(o, r, l), ()=>h.removeEventListener(o, r, l)), p = L(()=>[
                b(t),
                I(a)
            ], ([h, o])=>{
            if (u(), !h) return;
    ...
    we = function(e = {}) {
        const { navigator: t = D, read: n = !1, source: i, copiedDuring: a = 1500, legacy: c = !1 } = e, u = z(()=>t && "clipboard" in t), s = H("clipboard-read"), p = H("clipboard-write"), m = R(()=>u.value || c), h = S(""), o = S(!1), r = $(()=>o.value = !1, a);
        function l() {
    ...
    function le(e, t, n, i = {}) {
        ...
        if (!n) return g;
        const E = I(t), N = ue(E), v = (a = i.serializer) != null ? a : ce[N], { pause: y, resume: x } = K(g, ()=>q(g.value), {
            flush: c,
            deep: u,
            eventFilter: r
        });
    ...
    function de(e, t, n = {}) {
        ...
        }, p = R(()=>Array.isArray(e) ? e.map((o)=>b(o)) : [
                b(e)
            ]), m = L(p, (o)=>{
            if (s(), u.value && i) {
    ...
    ge = function(e, t = {
        ...
        const { window: i = A, box: a = "content-box" } = n, c = R(()=>{
            var o, r;
...
export { ye as a, be as b, ge as c, re as d, ve as o, we as u, __tla };
