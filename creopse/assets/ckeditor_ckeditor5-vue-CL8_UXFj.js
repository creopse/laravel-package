...
import { i as O, a as j, u as T, g as U, b as K, c as L, d as N, e as B, l as M } from "./ckeditor_ckeditor5-integrations-common-Bz1Gquc2.js";
import { d as S } from "./lodash-es-DCTpQg3n.js";
let de, oe, C, le;
let __tla = (async ()=>{
    const w = {}, g = {
        vue: {
        ...
        pinia: {
            get: ()=>()=>d(new URL("__federation_shared_pinia-C8WNsV9R.js", import.meta.url).href),
            import: !0
        },
        react: {
            get: ()=>()=>d(new URL("__federation_shared_react-Cf2-7iNb.js", import.meta.url).href),
            import: !0
        },
        "react-dom": {
            get: ()=>()=>d(new URL("__federation_shared_react-dom-BZFw873e.js", import.meta.url).href),
            import: !0
        },
        zustand: {
            get: ()=>()=>d(new URL("__federation_shared_zustand-HafgfWiF.js", import.meta.url).href),
            import: !0
        },
        ckeditor5: {
            get: ()=>()=>d(new URL("__federation_shared_ckeditor5-Bgw5AuKW.js", import.meta.url).href),
            import: !0
        },
        "@ckeditor/ckeditor5-vue": {
            get: ()=>()=>d(new URL("__federation_shared_@ckeditor/ckeditor5-vue-W4BQCW4e.js", import.meta.url).href),
            import: !0
        }
    ...
    const y = await C("vue"), { version: q, defineComponent: x, useModel: F, ref: f, watch: E, onMounted: W, markRaw: z, onBeforeUnmount: Q, openBlock: G, createBlock: Y, resolveDynamicComponent: H, mergeModels: b, computed: J, watchEffect: X, shallowReadonly: _, toValue: Z } = await C("vue"), $ = B("vue", {
        version: "7.4.0",
        frameworkVersion: q
    });
    function ee(e) {
    ...
    function k() {
        const e = U();
        return e ? !L(e.version) || K(e.version) || N(e.version).major >= 48 : !1;
    }
    let p, ae, re;
