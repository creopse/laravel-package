import { i as ye, __tla as __tla_0 } from "./ckeditor_ckeditor5-vue-D3nqwZpw.js";
let An, Pn, xn, Gn, bn, In;
let __tla = Promise.all([
    ...
    function qt(e) {
        ...
        for(let r = 0; r < n.length; ++r){
            const o = n[r].replace(Ye, " "), l = o.indexOf("="), h = re(l < 0 ? o : o.slice(0, l)), g = l < 0 ? null : re(o.slice(l + 1));
            if (h in t) {
                let i = t[h];
                B(i) || (i = t[h] = [
                    i
    ...
    const { computed: L, defineComponent: nt, getCurrentInstance: Tn, h: rt, inject: ee, nextTick: Qt, provide: ge, reactive: zt, ref: Yt, shallowReactive: Jt, shallowRef: Xt, unref: Z, watch: Zt, watchEffect: Dn } = await ye("vue");
    ...
    En = nt({
        ...
        useLink: Ue,
        setup (e, { slots: t }) {
            const n = zt(Ue(e)), { options: r } = ee(oe), o = L(()=>({
    ...
    const je = (e, t, n)=>e ?? t ?? n, On = nt({
        ...
        setup (e, { attrs: t, slots: n }) {
            const r = ee(ve), o = L(()=>e.route || r.value), l = ee(be, 0), h = L(()=>{
                let f = Z(l);
    ...
    Gn = function(e) {
        ...
        const d = he.bind(null, (s)=>"" + s), a = he.bind(null, St), c = he.bind(null, re);
        function u(s, m) {
            let p, v;
        ...
        function ut() {
            return te && i.value !== M ? Promise.resolve() : new Promise((s, m)=>{
                ae.add([
                    s,
                    m
                ]);
        ...
        function ue(s) {
            return te || (te = !s, ct(), ae.list().forEach(([m, p])=>s ? p(s) : m()), ae.reset()), s;
        }
        function we(s, m, p, v) {
        ...
        const ne = new Set, z = {
            ...
            install (s) {
                ...
                const p = s.unmount;
                ne.add(s), s.unmount = function() {
                    ne.delete(s), ne.size < 1 && (f = M, Q && Q(), Q = null, i.value = M, fe = !1, te = !1), p();
                };
            }
        };
        function q(s) {
...
export { An as R, Pn as a, xn as b, Gn as c, bn as o, In as u, __tla };
