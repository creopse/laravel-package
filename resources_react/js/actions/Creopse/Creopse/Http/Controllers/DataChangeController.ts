...
/**
* @see \Creopse\Creopse\Http\Controllers\DataChangeController::showByTableName
...
*/
export const showByTableName = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showByTableName.url(args, options),
    method: 'get',
})

showByTableName.definition = {
    methods: ["get","head"],
...
* @route '/api/data-changes/table/{tableName}'
*/
showByTableName.url = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { tableName: args }
    }
    ...
    return showByTableName.definition.url
...
* @route '/api/data-changes/table/{tableName}'
*/
showByTableName.get = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showByTableName.url(args, options),
    method: 'get',
})
...
* @route '/api/data-changes/table/{tableName}'
*/
showByTableName.head = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: showByTableName.url(args, options),
    method: 'head',
})
...
* @route '/api/data-changes/table/{tableName}'
*/
const showByTableNameForm = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: showByTableName.url(args, options),
    method: 'get',
})
...
* @route '/api/data-changes/table/{tableName}'
*/
showByTableNameForm.get = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: showByTableName.url(args, options),
    method: 'get',
})
...
* @route '/api/data-changes/table/{tableName}'
*/
showByTableNameForm.head = (args: { tableName: string | number } | [tableName: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: showByTableName.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
showByTableName.form = showByTableNameForm

const DataChangeController = { index, store, show, update, destroy, showByTableName }

export default DataChangeController