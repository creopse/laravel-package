...
export const useNewsletter = () => {
   ...
   */
  const subscribeEmail = async (email: string, successCallback?: () => void) => {
   ...
   */
  const subscribePhone = async (phone: string, successCallback?: () => void) => {
   ...
   */
  const subscribe = async (type: 'email' | 'phone', contact: string, successCallback?: () => void) => {
    setIsLoading(true)
